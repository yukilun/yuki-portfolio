<template>
    <ScrollToggle class="contact-actions flex-1 flex flex-col items-center">
        ...
        <div class="social-media flex gap-5 mb-10">
            ...
            <NuxtLink to="https://github.com/yukilun" class="transition-all opacity-70 hover:opacity-100 hover:scale-110">
        ...
        <form @submit="handleSubmit"
            ...
            <div class="flex gap-2 justify-end items-center">
                ...
                <button type="submit" class="button px-4 py-2 self-end flex-shrink-0 disabled:hover:scale-100 " :disabled="isSending">
